...
def update_constant_flux_temp(live_vars, Aw, Ab, Ap, ins, distance):
    ...
    return constant_flux_temp(**live_vars)


def update_constant_flux_area(live_vars, Aw, Ab, Ap, ins, distance):
    live_vars["Albedo"]["w"] = Aw
    live_vars["Albedo"]["b"] = Ab
    live_vars["Albedo"]["none"] = Ap
    live_vars["ins_p"] = ins
    live_vars["Fsnom"] = calc.update_solar_constant(calc.fromAU(distance))
    return constant_flux_area(**live_vars)
